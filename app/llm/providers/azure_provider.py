...
async def chat(
    api_key: str, model: str, messages: list[ChatMessage],
    endpoint: str = "", api_version: str = "2024-10-21", **kwargs
) -> ChatResponse:
...
async def embed(api_key: str, model: str, text: str, endpoint: str = "", api_version: str = "2024-10-21") -> list[float]:
